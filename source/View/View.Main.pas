...
begin
  ...
  try
    ...
    frmRelCliente.RLReport1.Preview();
  finally
    LCliente.Free;
    frmRelCliente.Free;
  end;
...
begin
  frmChamaRelVendas := TfrmChamaRelVendas.Create(nil);
  try
    frmChamaRelVendas.ShowModal;
  finally
    frmChamaRelVendas.Free;
  end;
end;
